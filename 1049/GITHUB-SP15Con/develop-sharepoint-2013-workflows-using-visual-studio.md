...
|Позволяет создавать пользовательский код  <br/> |Нет  <br/> |Нет  <br/> <br/> **Примечание**<br/> Отличается от предыдущих версий. В SharePoint 2013 рабочие процессы исключительно декларативные, а в Visual Studio для создания рабочих процессов используется визуальная поверхность разработки.           |
...
|Можно использовать только действия, которые утверждены администратором сайта  <br/> |Да  <br/> |Да  <br/> <br/> **Примечание**<br/> Отличается от предыдущих версий. Ранее рабочие процессы и действия, созданные с помощью Visual Studio, были основаны на коде и развертывались на уровне фермы, поэтому утверждение администратора не требовалось.           |
