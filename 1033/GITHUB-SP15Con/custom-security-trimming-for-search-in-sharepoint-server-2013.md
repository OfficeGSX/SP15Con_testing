...
| _RulePath_ <br/> |Required for post-trimmers; optional for pre-trimmers. The crawl rule for the security trimmer.  <br/> <br/> **NOTE**<br/> We recommend using one crawl rule per content source.           |
