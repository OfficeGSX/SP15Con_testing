...
![Figure 2. The Message Queuing feature added to Ser](images/ng_MsmqQueues.png)
    ...
    > **NOTE**
      <br/> When you first add the **Message Queuing** feature, the **Private Queues** folder is empty. However, after a workflow runs that fires an event (or a workflow triggered by a SharePoint content change event runs), the **Private Queues** folder is populated as shown in Figure 2.
